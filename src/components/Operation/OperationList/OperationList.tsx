...
/**
 * Компонент списка операций. Этот компонент принимает массив данных и выводит список их компонентов-операций, который мы делали ранее. Сделать динамическое добавление операций в список, для этого используйте функции создания случайной операции, которые вы писали в первом домашнем задании. Добавление можно сделать с помощью кнопки "показать еще".
 */
