...
/**
 * Компонент модального окна. Состоит из темной маски, белого квадратного окна и кнопки закрытия. Обработчики писать пока не нужно. 
 ...
 */
export const Modal: FC<ModalProps> = ({visible = false, onCloseModalWindow, children}): ReactElement => {
    return (
        <div className={cn("modal", {open: visible})} id="my-modal">
            <div className="modal__box" >
                <button className="modal__close-btn" id="close-my-modal-btn" onClick={() => onCloseModalWindow(false)}>
