            ...
            <ul className="navbar-nav">
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu dropdown-menu-end">
                  <li>
                    <a className="dropdown-item">{t('navbar.shoes')}</a>
                  </li>
                  <li>
                    <a className="dropdown-item">{t('navbar.jeans')}</a>
                  </li>
                  <li className="nav-item dropend">
                    ...
                    <ul className="dropdown-menu dropdown-menu-end">
                      <li>
                        <a className="dropdown-item">{t('navbar.mensSportswear')}</a>
                      </li>
                      <li>
                        <a className="dropdown-item">{t('navbar.womensSportswear')}</a>
                      </li>
                      <li>
                        <a className="dropdown-item">{t('navbar.babysSportswear')}</a>
                      </li>
                    </ul>
                  </li>
                  <li>
                    <a className="dropdown-item">{t('navbar.coat')}</a>
                  </li>
                  <li>
                    <a className="dropdown-item">{t('navbar.shirts')}</a>
                  </li>
                </ul>
              </li>
            </ul>
