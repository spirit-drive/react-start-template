                        ...
                        <div className="bg-white product-content p-3 h-100">
                            ...
                            <div className="row mt-3">
                                <div className="col-lg-4  mb-2">
                                    <div className="card h-100">
                                        <div className="card-body">
                                            <h5 className="card-title"><i className="fa-solid fa-shield-halved"></i> Гарантия</h5>
                                ...
                                <div className="col-lg-4  mb-2">
                                    <div className="card h-100">
                                        <div className="card-body">
                                            <h5 className="card-title"><i className="fa-solid fa-truck-fast"></i> Доставка</h5>
                                            <ul className="list-unstyled">
                                ...
                                <div className="col-lg-4  mb-2">
                                    <div className="card h-100">
                                        <div className="card-body">
                                            <h5 className="card-title"><i className="fa-regular fa-credit-card"></i> Оплата</h5>
                                            <ul className="list-unstyled">
