...
type Customer = { id: string | number; name: string; age: number; isSubscribed: boolean };

type TransformedCustomer = { [key: string | number]: { name: string; age: number; isSubscribed: boolean } };
