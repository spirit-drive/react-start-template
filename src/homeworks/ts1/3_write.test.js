...
describe('all', () => {
  it('operation', () => {
    ...
    //expect(operation).toHaveProperty('desc'); property не обязателен
  ...
  it('product', () => {
    ...
    //expect(product).toHaveProperty('desc'); property не обязателен
    expect(product).toHaveProperty('createdAt');
    //expect(product).toHaveProperty('oldPrice'); property не обязателен
